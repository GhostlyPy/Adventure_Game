...
function displayPage(scene, page) {
  ...
  this.renderCharacter(scene, page.character);
...
function fetchPage(page) {
  ...
  const pages = [{
...

    {
      ...
      options: [{
          option: 'How do I help',
          nextPage: 6
        },
        {
          option: 'No I don\'t think so',
          nextPage: 4
        },
      ]
    },
